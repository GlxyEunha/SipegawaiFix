                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 border-b border-gray-200 text-center">
                                    <a href="{{ route('pegawai.edit', $user->nip) }}" class="px-3 py-1 bg-blue-500 text-white text-xs font-semibold rounded">Edit</a>
                                    <form action="{{ route('pegawai.destroy', $user->nip) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
