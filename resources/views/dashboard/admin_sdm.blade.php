...
@section('body')
    ...
    <div class="flex ml-auto">
       {{-- Search --}}
       <form id="search-form" method="GET" class="relative mx-4 lg:mx-0">
        ...
        {{-- Filter by Golongan --}}
        <form action="{{ url()->current() }}" method="GET" class="flex ml-2 mb-1 items-center">
            <select id="gol" name="gol" class="p-3 text-xs font-medium text-gray-500 border ps-3 border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onchange="this.form.submit()">
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 border-b border-gray-200 text-center">
                                    <a href="{{ route('admin_sdm.users.edit', $user->nip) }}" class="px-3 py-1 bg-blue-500 text-white text-xs font-semibold rounded">Edit</a>
                                    <form action="{{ route('admin_sdm.users.destroy', $user->nip) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
