...
@section('body')
    ...
    <div class="flex items-left">
            {{-- Search & Filter --}}
            <form id="search-form" method="GET" action="{{ route('admin_sdm.dashboard') }}" class="flex items-center">
                {{-- Search --}}
        ...
        <a href="{{ route('admin_sdm.akun.export') }}" class="inline-block px-6 py-3 bg-indigo-600 text-white font-medium rounded-md hover:bg-indigo-700">
        Export Excel Akun Pegawai
        </a>
    </div>
