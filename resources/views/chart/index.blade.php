...
@section('body')
        ...
        <div class="flex flex-wrap -mx-6">
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3">
                <div class="bg-white shadow-sm rounded-md p-6">
                    <h4 class="text-xl font-semibold text-gray-700 mb-4">Jumlah Pegawai per Golongan</h4>
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3">
                <div class="bg-white shadow-sm rounded-md p-6">
                    <h4 class="text-xl font-semibold text-gray-700 mb-4">Jumlah Pegawai per Pendidikan</h4>
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3">
                <div class="bg-white shadow-sm rounded-md p-6">
                    <h4 class="text-xl font-semibold text-gray-700 mb-4">Jumlah Pegawai per Usia</h4>
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3">
                <div class="bg-white shadow-sm rounded-md p-6">
                    <h4 class="text-xl font-semibold text-gray-700 mb-4">Jumlah Pegawai per Jenis Kelamin</h4>
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3">
                <div class="bg-white shadow-sm rounded-md p-6">
                    <h4 class="text-xl font-semibold text-gray-700 mb-4">Jumlah Pegawai per Jabatan</h4>
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3">
                <div class="bg-white shadow-sm rounded-md p-6">
                    <h4 class="text-xl font-semibold text-gray-700 mb-4">Jumlah Pegawai per Agama</h4>
    ...
    <script>
        ...
        var data = @json($jabatan);
        var labels = data.map(item => item.jabatan);
    ...
    <script>
        ...
        var genderChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: {!! json_encode(array_keys($gender)) !!}, // Ambil label dari array
                datasets: [{
                    label: 'Jumlah Pegawai',
                    data: {!! json_encode(array_values($gender)) !!}, // Ambil nilai dari array
    ...
    <script>
        ...
        var ageData = @json($usia);  // Mengambil data dari controller
        var labels = ageData.map(item => item.age_group);  // Mengambil kategori usia
        var values = ageData.map(item => item.count);  // Mengambil jumlah pengguna di setiap kategori
    
        new Chart(ctx, {
            type: 'bar',  // Menggunakan chart tipe bar
            data: {
                labels: labels,  // Label berdasarkan kategori usia
                datasets: [{
                    label: 'Jumlah Pengguna per Kelompok Usia',  // Label chart
                    data: values,  // Data untuk jumlah
                    backgroundColor: 'rgba(75, 192, 192, 0.6)',  // Warna background bar
    ...
    <script>
        ...
        var data = @json($pendidikan);
        var labels = data.map(item => item.pendidikan);
        var values = data.map(item => item.jumlah);
