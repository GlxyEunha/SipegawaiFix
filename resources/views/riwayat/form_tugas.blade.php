...
@endif
<h3 class="text-gray-700 text-3xl font-medium">Form Tambah Riwayat Tugas</h3>
<br>
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        <form action="{{ route('admin_user.storeRiwayatTugas') }}" method="POST">
            @csrf
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="w-full">
                    ...
                    <input type="text" name="nama_tugas" id="nama_tugas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nama Tugas" required="">
                </div>
                <div class="w-full">
