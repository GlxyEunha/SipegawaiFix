...
@section('body')
    ...
    <br>
    <a href="{{ route('admin_user.riwayatTugas') }}" class="inline-block px-6 py-3 bg-indigo-600 text-white font-medium rounded-md hover:bg-indigo-700">
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 border-b border-gray-200 text-center">
                                    <a href="{{ route('admin_user.editTugas', $t->id_tugas) }}" class="px-3 py-1 bg-blue-500 text-white text-xs font-semibold rounded">Edit</a>
                                    <form action="{{ route('admin_user.destroyTugas', $t->id_tugas) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
