...
@section('body')
    ...
    <div class="flex items-left">
            {{-- Search & Filter --}}
            <form id="search-form" method="GET" action="{{ route('pegawai.gaji.index') }}" class="flex items-center">
                {{-- Search --}}
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('pegawai.gaji.setujui', $user->nip) }}" method="POST" class="d-inline">
                                        @csrf
