...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
    ...
    <nav class="mt-10">
        <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="{{ route('pegawai.dashboard') }}">
        ...
        <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="">
            ...
            <span class="mx-3">Pengajuan</span>
        </a>

        @if($permissions && $permissions->daftar_pegawai == 1)
        <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="{{ route('pegawai.daftar_pegawai') }}">
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
            </svg>
        ...
        <div x-data="{ open: false }">
            ...
            <div x-show="open" class="mt-2 space-y-2 bg-gray-800">
                <a href="{{ route('pegawai.index') }}" class="block px-8 py-2 text-gray-400 hover:bg-gray-700 hover:text-gray-100">Isi Data</a>
                <a href="{{ route('pegawai.upload') }}" class="block px-8 py-2 text-gray-400 hover:bg-gray-700 hover:text-gray-100">Upload File</a>
            </div>
        </div>
        @endif
